...
//--------------------------------------------------------------
use App\Http\Controllers\NotificationReadController; //ベル
//--------------------------------------------------------------
...
Route::post('/save-subscription', function (Request $request) {
    ...
    try {
        ...
        $sub = json_decode($request->getContent(), true);

        \Log::info('PARSED SUB', $sub);
...
Route::get('/dashboard/open', NotificationReadController::class)->name('notification.read');
...
Route::delete('/user_destination/delete/{id}', [MasterController::class, 'userDestinationDelete'])
    ...
    //Route::post('/change-date', [DateController::class, 'changeDate'])->name('change.date');
    //Route::post('/change-date', [PreviewController::class, 'changeDate'])->name('change.date');
    ...
    /*
    Route::post('/change-date', [PreviewController::class, 'changeDate'])->name('change.date');
    Route::post('/change-date', [DeleteController::class, 'changeDate'])->name('change.date');
    */
    Route::post('/change-date', [DateController::class, 'changeDate'])->name('change.date');
